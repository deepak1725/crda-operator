...
func bouncerDeploymentName(v *f8av1alpha1.CodeReadyAnalytics) string {
...
func (r *CodeReadyAnalyticsReconciler) pvcDeployment(cr *f8av1alpha1.CodeReadyAnalytics) *corev1.PersistentVolumeClaim {
...
func (r *CodeReadyAnalyticsReconciler) pvDeployment(cr *f8av1alpha1.CodeReadyAnalytics) *corev1.PersistentVolume {
...
func (r *CodeReadyAnalyticsReconciler) bouncerDeployment(cr *f8av1alpha1.CodeReadyAnalytics) *appsv1.StatefulSet {
...
func asOwner(hs *f8av1alpha1.CodeReadyAnalytics) metav1.OwnerReference {
	trueVar := true
...
func (r *CodeReadyAnalyticsReconciler) bouncerService(cr *f8av1alpha1.CodeReadyAnalytics) *corev1.Service {
	labels := labels(cr, "database")
